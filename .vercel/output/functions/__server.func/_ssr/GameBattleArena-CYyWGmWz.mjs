...
import { c as require_jsx_runtime, l as require_react, xt as Vector3 } from "../_libs/@react-three/drei+[...].mjs";
import { r as HIT_STOP_DURATIONS } from "./BoneHitboxSystem-DOra5Syf.mjs";
import { a as dynamic, i as FighterState, l as getBannonFighter, n as DEFAULT_TOURNAMENT_SETTINGS, o as useAuth, u as __exportAll } from "./routes-ClavP_F3.mjs";
import { t as useGesture } from "../_libs/use-gesture__react.mjs";
import { a as getMoveById, i as getCharacterMoveSet } from "./CharacterMoveSetSystem-CtkEuY0E.mjs";
...
import { a as useMatchRecorder, i as saveReplayToSupabase, t as PauseMenuRecorder } from "./MatchRecorder-BFg4FPsX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/GameBattleArena-CYyWGmWz.js
...
var FrameDataHitboxSystem = class {
	...
	*/
	checkCollision(attackerX, attackerZ, facing, opponentX, opponentZ, opponentIsBlocking, currentFrame) {
		...
		const halfW = (hb.width + .4) * .5;
		const halfD = (hb.depth + .4) * .5;
...
var GameBattleArena_exports = /* @__PURE__ */ __exportAll({ default: () => GameBattleArena });
var CombatArena3D = dynamic(() => import("./CombatArena3D-BGZYJMFr.mjs"), {
	ssr: false,
...
function GameBattleArena({ p1Fighter, p2Fighter, onMatchEnd, onBack, roundLabel, p1SkinTint, p2SkinTint, settings = DEFAULT_TOURNAMENT_SETTINGS, stageId = "urban_night", debugSettings = DEFAULT_DEBUG_SETTINGS, isPracticeMode = false }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const onKeyDown = (e) => {
			...
			if (e.key === "q" || e.key === "Q") {
				p1ZRef.current = Math.max(-2, p1ZRef.current - Z_STEP * 5);
		...
		const zReturnInterval = setInterval(() => {
			p1ZRef.current *= .9;
			if (Math.abs(p1ZRef.current) < .05) p1ZRef.current = 0;
			setP1Z(p1ZRef.current);
		}, 50);
...
//#endregion
export { CHARACTER_BLOOM as n, ATTACK_ROOT_MOTION_PROFILES as r, GameBattleArena_exports as t };
