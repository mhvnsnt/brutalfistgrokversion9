...
import { i as getGlbEntryForFighter, n as BANNON_MODELS_RAW, o as resolveGlbUrl, t as BANNON_GLB_PLAYABLE_MODELS } from "./bannonGlbRoster-DSrchjC5.mjs";
import { c as require_jsx_runtime, l as require_react } from "../_libs/@react-three/drei+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-ClavP_F3.js
...
var CharacterSelect = dynamic(() => import("./CharacterSelect-DJa16qUt.mjs"), { ssr: false });
var GameBattleArena = dynamic(() => import("./GameBattleArena-CYyWGmWz.mjs").then((n) => n.t), { ssr: false });
var TournamentBracket = dynamic(() => import("./TournamentBracket-4hPQof9g.mjs"), { ssr: false });
var TournamentStatsScreen = dynamic(() => import("./TournamentStatsScreen-BH78hY9G.mjs"), { ssr: false });
var TournamentBrowserScreen = dynamic(() => import("./TournamentBrowserScreen-o9YFcX_3.mjs"), { ssr: false });
var AuthScreen = dynamic(() => import("./AuthScreen-Cj9Uf4rX.mjs"), { ssr: false });
var PostTournamentScreen = dynamic(() => import("./PostTournamentScreen-BlFY3qQA.mjs"), { ssr: false });
var PlayerProfileScreen = dynamic(() => import("./PlayerProfileScreen-DCfY5PF3.mjs"), { ssr: false });
var TournamentSettingsScreen = dynamic(() => import("./TournamentSettingsScreen-CCuoSyhX.mjs"), { ssr: false });
var LeaderboardScreen = dynamic(() => import("./LeaderboardScreen-C2vbp3GZ.mjs"), { ssr: false });
var PracticeArenaScreen = dynamic(() => import("./PracticeArenaScreen-D3rP3px-.mjs"), { ssr: false });
var StoryModeScreen = dynamic(() => import("./StoryModeScreen-Bi7frI9X.mjs"), { ssr: false });
var StageSelectScreen = dynamic(() => import("./StageSelectScreen-3Lbds92_.mjs"), { ssr: false });
var SeasonalTournamentScreen = dynamic(() => import("./SeasonalTournamentScreen-BrHOhz62.mjs"), { ssr: false });
var MatchmakingQueueScreen = dynamic(() => import("./MatchmakingQueueScreen-CZa62HEy.mjs"), { ssr: false });
var SpectatorViewerScreen = dynamic(() => import("./SpectatorViewerScreen-DaYjjujj.mjs"), { ssr: false });
var AnimationTestArena = dynamic(() => import("./AnimationTestArena-C2_Igfbh.mjs"), { ssr: false });
var PhotoBoothScreen = dynamic(() => import("./PhotoBoothScreen-DIDCUwMv.mjs"), { ssr: false });
var ConceptArtGallery = dynamic(() => import("./ConceptArtGallery-9eo6Pl8d.mjs"), { ssr: false });
var PreCombatValidationScreen = dynamic(() => import("./PreCombatValidationScreen-Cg_tJgJ0.mjs"), { ssr: false });
function App() {
...
//#endregion
export { dynamic as a, getAllBannonFighters as c, FighterState as i, getBannonFighter as l, DEFAULT_TOURNAMENT_SETTINGS as n, useAuth as o, TournamentSettingsScreen$1 as r, BANNON_ROSTER as s, routes_exports as t, __exportAll as u };
