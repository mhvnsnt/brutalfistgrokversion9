...
//#region node_modules/.nitro/vite/services/ssr/assets/StageSelectScreen-3Lbds92_.js
...
function StageGeometry({ stageId }) {
	...
	const cfg = STAGE_CONFIGS[resolvedId];
	...
	const ambientIntensity = cfg?.ambientIntensity ?? .25;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		[-4, 4].map((x, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("mesh", {
			position: [
				x,
				1.5,
				-3
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("mesh", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("planeGeometry", { args: [8, .15] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("meshStandardMaterial", {
				color: accentColor,
				emissive: accentColor,
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("mesh", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("planeGeometry", { args: [20, 10] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("meshStandardMaterial", {
				color: ambientColor,
				transparent: true,
				opacity: .6
			})]
