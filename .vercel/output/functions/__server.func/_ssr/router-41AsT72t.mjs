...
//#region node_modules/.nitro/vite/services/ssr/assets/router-41AsT72t.js
...
var styles_default = "/assets/styles-cSI5bLxL.css";
var APP_NAME = "Brutal Fist";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Brutal Fist — 3D PS1-style fighting game with the Bannon roster."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-ClavP_F3.mjs").then((n) => n.t);
