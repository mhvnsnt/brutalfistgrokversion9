...
export const SEMANTIC_PREFERRED_CLIPS: Record<string, string[]> = {
  ...
  attack_1:       ['BOXING', 'BODY_JAB_CROSS', 'COMBO_PUNCH', 'BOXING__1_', 'BOXING__2_', 'BOXING__3_', 'BOXING__4_', 'ILLEGAL_ELBOW_PUNCH', 'BASEBALL_HIT'],
  attack_2:       ['HURRICANE_KICK', 'DROP_KICK', 'ILLEGAL_KNEE', 'TIGER_FEINT_KICK', 'BASH', 'AU', 'CAPOEIRA', 'CROSS_JUMPS'],
