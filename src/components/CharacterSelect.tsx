...
import { getSelectMugOverride } from '../lib/pixelate';
...
function RosterSlot({
  ...
  const face = getSelectMugOverride(fighter.id) ?? fighter.selectMugUrl ?? fighter.conceptArtUrl ?? `/portraits/select/${fighter.id}.jpg`;
    ...
    >
      ...
      <img
        ...
        onError={(e) => {
          ...
          el.src = `/portraits/concept/${fighter.id}.png`;
        }}
      />
